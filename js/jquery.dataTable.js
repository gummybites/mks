...
//Text validation for mother occupation
       function forsearch(e){
                  var keyCode = e.keyCode == 0 ? e.charCode : e.keyCode; 
                                          //     65 – 90 (Uppercase Alphabets) a      97 – 122 (Lowercase Alphabets) 
                ...
                ($.inArray('asc', oCol.asSorting) == -1 && $.inArray('desc', oCol.asSorting) == -1) )
      {
		...
		function _fnFeatureHtmlFilter ( oSettings )
		{
			...
			sSearchStr = (sSearchStr.indexOf('_INPUT_') !== -1) ?
			  ...
			  sSearchStr==="" ? '<input type="text" name="search"  id="search" onkeypress="return forsearch(event);" ondrop="return false;" onpaste="return false;" />' : sSearchStr+' <input type="text" name="search" id="search" onkeypress="return forsearch(event);" ondrop="return false;" onpaste="return false;" />';
