...
?>
											...
											if(isset($_POST['submit'])){
												...
												$yr=$_POST['year'];
													...
													mysql_query("UPDATE tbl_subjects set  subjects= '$yr' where yearlevel='Grade 7' and subjects= '$subjectss' ");
								...
								<div class='demo_jui' >
                                          ...
                                          <tr>
                                              ...
                                              <th bgcolor='#FCAC45'><center>Action</center></th>
												...
												$qry=("SELECT * from tbl_subjects where yearlevel='Grade 7' and Extras='no' LIMIT $limit");
												$res= mysql_query($qry);
												...
												while($qry=mysql_fetch_array($res)){
													...
													echo "<tr><td>$lev</td> <td>$code</td> <td>$subj</td> <td><a href='?subject=$subj' >Edit name</a></td></tr>";
												}
												?>
											...
											$qry = "SELECT * from tbl_subjects where yearlevel='Grade 7' and subjects='$get_subject'";
											...
											<a href='subjects.php' class='btn btn-danger'>Back</a>
											     </span></div></div>";	
