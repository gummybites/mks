...
?>
											...
											if(isset($_POST['submit'])){
												...
												$yr=$_POST['year'];
													...
													mysql_query("UPDATE tbl_subjects set  subjects= '$yr' where yearlevel='Grade 9' and  subjects= '$subjectss' ");
													header('Refresh:1; grade9subjects.php');
								...
								<div class='demo_jui'>
                                          ...
                                          <tr>
                                              ...
                                              <th bgcolor='#FCAC45'><center>Action</center></th>
												...
												$qry=("SELECT * from tbl_subjects where yearlevel='Grade 9' and Extras='no' LIMIT $limit");
												$res= mysql_query($qry);
											...
											<a href='grade9subjects.php' class='btn btn-danger'>Back</a>
											     </span></div></div>";	
