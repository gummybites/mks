...
exit;
               ...
               header("Refresh: 1; url=tuitionfortransferee.php?tuition=$username");
      ...
      <div class="col-md-10 col-xs-10 content">
              ...
              <p class="hr-warning" ></p>
               ...
               if(isset($_GET['tuition'])){
                  ...
                  echo "<a href='tuitionfortransferee.php'>Back</a>";
                  ...
                  echo "<a href='tuitionfortransferee.php?tuition=$user'>Back</a>";
                  echo "<div class='row'>
                ...
                //This is for mode of payment
                  ...
                  echo "<div class='row' id='button'>
                        ...
                        <a href='tuitionfortransferee.php?tuition=$user' class='btn btn-danger'>Back</a></div>";
                ...
                <div class='demo_jui'>
                            ...
                            $qry="SELECT * from tbl_prospectivestudents where applicant_number!='0' and status='Transferee'";
