...
exit;
  ...
  if(isset($_POST['enter'])){
                        ...
                        $applicantnumber=$_POST['applicant_number'];
                          ...
                          header("Refresh: 1; url='transferee.php'");
      ...
      <div class="col-md-10 content col-xs-10 col-offset-1">
              ...
              <p class="hr-warning" /></p>
                <ol class="breadcrumb bread-warning">
                  ...
                  <li ><a href='prospectivestudents.php'>New Student</a></li>
             ...
             if(isset($_POST['enter'])){
                ...
                echo "<a  href='transferee.php'>Back</a>";
                echo "<div class='row'>
                      <div class='col-md-4'>
                ...
                $studcount=$_GET['studcount'];
                 $z=$_GET['Applicant'];
                   ...
                   $q = "SELECT applicant_number from tbl_prospectivestudents where status='Transferee' and id='$studcount'";
                    $r = mysql_query($q);
             ...
             <div class='demo_jui'>
                            ...
                            $qry="SELECT * from tbl_studentrequirements inner join tbl_prospectivestudents on tbl_prospectivestudents.id=tbl_studentrequirements.id where status='Transferee'";
                            $res=mysql_query($qry);
                            ...
                            $z++;
                             ...
                             if(($birth||$form||$moral=='1') && ($stat=='Transferee')){  
                              ...
                              if($applicant_no!='0'){
                                ...
                                echo "<tr><td>$sname</td><td>$fname</td><td>$mname</td><td> <center><a href='?studcount=$id&&Applicant=$z'><img src='CREATEACCOUNT.png' width='130px' height='40px'></a></a></tr>";
