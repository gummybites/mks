...
?>
  ...
  if(isset($_POST['createstudentaccountbutton'])){
                        ...
                        $student_no=$_POST['student_no'];
                          ...
                          mysql_query("INSERT INTO tbl_cashierpayment (username) values ('$student_no')");
                          header("Location:createaccountfornewstudent.php");
...
<head>
                    ...
                    <title>Create Student Account for New student</title>
...
<ul class="nav nav-tabs">
  <li class="active"><a href="#"><i class="fa fa-plus"></i> Create Account for New Student</a></li> 
  <li><a href="createaccountfortransfereestudent.php"><i class="fa fa-plus"></i> Create Account for Transferee Student</a></li>  
                             ...
                             if(mysql_num_rows($result) >= 0) 
                              {
                                 ...
                                 $z=0;
                                  ...
                                  if($applicant_no!='0'){
                                      ...
                                      <td><center><?php echo $status?></center></td>
                                      <td><center><?php echo $sname.','.$fname.','.$mname?></center></td>
                                      <td><center><a href="createaccountfornewstudent.php?id=<?php echo $id?>&&applicant=<?php echo $z?>">Create</a></center></td>
                                      </tr>
                                      <?php
