  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <ul class="nav navbar-nav navbar-right">
        <li> <a href='transfereeregister.php'>Don't have an account yet? Register Here</a></li>
      </ul>
    </div><!-- /.navbar-collapse -->
  </div><!-- /.container-fluid -->
</nav>     
<div class="container">
   <br><br>
            <div class="row text-center">
                <div class="col-md-12">
                    <strong>IF YOU ALREADY HAVE AN ACCOUNT READ THE <a href="#admission-modal" data-toggle="modal">ADMISSION PROCEDURE</a>  / FOR TRANSFEREES ONLY</strong>  
