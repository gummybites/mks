...
$qry="SELECT email, seeking, status, surname,firstname from tbl_studentregistration where email='$email' and seeking='Grade 7'";
$res=mysql_query($qry);
   ...
   <nav id='menu' class="navbar navbar-default navbar-fixed-top">
        ...
        <!-- Brand and toggle get grouped for better mobile display -->
          ...
          <ul class="nav navbar-nav navbar-right">
            <li><a href="freshmanlogout.php">Logout</a></li>
          </ul>
        </div><!-- /.navbar-collapse -->
    </div><!-- /.container-fluid -->
    </nav>   
    ...
    <div class="container">
              ...
              <form   onsubmit='return freshmanapplication()' action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="POST"  enctype="multipart/form-data">
                    ...
                    if($db_email==0){
                          ...
                          <div class='row'>
                          <a href='freshmanapplicationform.php' onclick="myFunction()"><img src='postprinticon.png'></a>
                          </div>
                           ...
                           <div class='text-center'>
                              ...
                              <img src='../../img/mkslogo.png' class='pull-left' width="150px" height="150px"> 
                                ...
                                <h3 ><strong>APPLICATION FOR ADMISSION (Freshmen) </strong></h3>
                          ...
                          //kapag may nakikitang laman ang table
                           ...
                           ?>
                            ...
                            <div class="col-md-4 col-xs-4 col-offset-1">
                                ...
                                <a href='freshmanapplicationform.php' class='btn btn-danger'>Clear</a>
                            </div>
                            </div>
