                                                  ...
                                                  $enc_password=mysql_real_escape_string(sha1(md5(trim(htmlspecialchars($pass)))));
                                                           ...
                                                           if (preg_match("/^[_\.0-9a-zA-Z-]+@([0-9a-zA-Z][0-9a-zA-Z-]+\.)+[a-zA-Z]{2,6}$/i", $email)) {
                                                                ...
                                                                $checkemail = mysql_num_rows($remail);
                                                                      if ($checkemail != 0){
                                                                                header("Location: transfereeregister.php?EmailAlreadyRegistered=error!");
                                                                                                                                 ...
                                                                                                                                 if(isset($_POST["captcha"]) && $_POST["captcha"]!="" && $_SESSION["code"]==$_POST["captcha"])
                                                                                                                                  {
                                                                                                                                            ...
                                                                                                                                            $qry=("INSERT into tbl_studentregistration (email,password, code, confirm_code, seeking, status, surname, firstname) values ('$email','$enc_password','0','$confirmed','','Transferee','$sname','$fname')");
                                                                                                                                            mysql_query($qry);

                                                                                                                                            $message= "Confirm your email
                                                                                                                                              Click the link below to verify your account 
                                                                                                                                                http://www.yahoo.com/transfereeregister.php?email=$email&code=$confirmed
                                                                                                                                            ";  
                                                            ...
                                                            header("Location: transfereeregister.php?InvalidEmail=error!");
        ...
        <div class='container'  class="col-md-12 col-xs-12 content">
          ...
          <form id='register-inputs' method="POST" onsubmit="return freshmanregister()" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                            ...
                            ?>
                                          ...
                                          echo "<div class='row'><div class='col-md-6'><div class='alert alert-danger' role='alert'> <a href='' class='close' data-dismiss='alert' aria-label='close'>&times;</a>This email is already registered! Please type another email...</div></div></div>";
                                          ...
                                          echo "<div class='row'><div class='col-md-6'><div class='alert alert-danger' role='alert'> <a href='' class='close' data-dismiss='alert' aria-label='close'>&times;</a>Please type a valid email!</div></div></div>"; 
                                           ...
                                           <div class='row'>
                                            <div class='col-md-6'>
                                            <strong>TO CREATE AN ACCOUNT READ THE <a href='../admission_requirements.php'>ADMISSION PROCEDURE</a>  / FOR TRANSFEREE ONLY</strong>  
                                           ...
                                           <div class='row'>
                                            ...
                                            <div class="input-group input-group-lg">
                                              <span class="input-group-addon">
                                               ...
                                               <input type='password' value='' maxlength="12" class='form-control' onkeypress="return forpassword(event);" ondrop="return false;" onpaste="return false;" id='password' name='password' placeholder='Password *'/>
                                                <span id='span-addon' class="input-group-addon">
                                                 <i id='pass'></i>
                                              </span>
                                            ...
                                            <div class="input-group input-group-lg">
                                              <span class="input-group-addon">
                                               ...
                                               <input type='password' value=''  maxlength="12" class='form-control input-sm' onkeypress="return forconfirmpassword(event);" ondrop="return false;" onpaste="return false;"  id='confirmpassword' name='confirmpassword' placeholder='Confirm Password *'/> 
                                            ...
                                            <a href="transfereeregister.php" class="btn btn-danger"  >Clear</a>
                                            </div>
                                            <div class='col-md-2'>
                                            Already have an account? 
                                            <br>
                                            <a href='transfereelogin.php'>Login Here</a>
                                            </div>
                                            </div>
