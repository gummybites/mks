...
$qry="SELECT email, status, surname, firstname from tbl_studentregistration where email='$email' and status='Transferee'";
$res=mysql_query($qry);
   ...
   <nav id='menu' class="navbar navbar-default navbar-fixed-top">
        ...
        <!-- Brand and toggle get grouped for better mobile display -->
          ...
          <ul class="nav navbar-nav navbar-right">
            <li><a href="transfereelogout.php">Logout</a></li>
          </ul>
        </div><!-- /.navbar-collapse -->
    </div><!-- /.container-fluid -->
    </nav>   
    ...
    <div class="container">
              ...
              <form   onsubmit='return freshmanapplication()'  method="POST"  enctype="multipart/form-data">
                    ...
                    if($db_email==0){
                          ...
                          ?>
                          <div class='row'>
                          <a href='transfereeapplicationform.php' onclick="myFunction()"><img src='postprinticon.png'></a>
                          </div>
                          ...
                          //kapag may nakikitang laman ang table
                           ...
                           ?>
                            ...
                            <div class="col-md-4 col-xs-4 col-offset-1">
                                ...
                                <a href='transfereeapplicationform.php' class='btn btn-danger'>Clear</a>
                            </div>
                            </div>
