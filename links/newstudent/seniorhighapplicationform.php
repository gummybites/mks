...
$qry="SELECT * from tbl_studentregistration where username='$username' and seeking='Grade 11' and prospectivestatus='pending'";
$res=mysql_query($qry);
...
<?php            
                        ...
                        elseif(isset($_POST['changeemail'])){
                          ...
                          //Checking email if it has already registered
                                                                ...
                                                                $checkemail = mysql_num_rows($remail);
                                                                      if ($checkemail != 0){
                                                                                header("Location: seniorhighapplicationform.php?EmailAlreadyRegistered=error!");
                                                                                
                                                                                            }else{
                                                                                              mysql_query("UPDATE tbl_studentregistration set email='$email' where username='$username'");
                                                                                              header("Location: seniorhighapplicationform.php?updatesuccess!");
                        ...
                        elseif(isset($_POST['edit_update'])){
                              ...
                              header("Location: seniorhighapplicationform.php?editapplication=$email");
                        }
                        ...
                        elseif(isset($_POST['edit_birthdate'])){
                              ...
                              header("Location: seniorhighapplicationform.php?editbirthdate=$email");
                              ...
                              header("Location: seniorhighapplicationform.php?editgender=$email");
                              ...
                              header("Location: seniorhighapplicationform.php?editreligion=$email");
...
<head>
                    ...
                    <title><?php if($db_code=='0'){
                                  ...
                                  echo "Email Verified: Senior High Application Form";
                                    } ?></title>
...
disp_setting+="scrollbars=yes,width=650, height=600, left=100, top=25";
   ...
   docprint.document.write('<br><center><B>APPLICATION FOR ADMISSION (SENIOR HIGH)</B></center>');
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <ul class="nav navbar-nav navbar-right">
        <li> <a href="seniorhighlogout.php"><i class="glyphicon glyphicon-log-out"></i> Logout</a></li>
      </ul>
    </div><!-- /.navbar-collapse -->
  </div><!-- /.container-fluid -->
</nav>     
...
<div class="container">
  <div class="col-sm-12 col-md-12 ">
            <div class="alert alert-warning">
                ...
                <a href='seniorhighapplicationform.php?email=<?php echo $db_email ?>' class='next'><i class='glyphicon glyphicon-refresh'></i> Resend confirmation link</a>
                <a href='seniorhighapplicationform.php?username=<?php echo $db_username ?>' class='next'><i class='glyphicon glyphicon-envelope'></i> Edit Email</a>
            </div>
  </div>
  </div>
<?php
...
$message= "Confirm your email
  Click the link below to verify your account 
    http://www.sims-mks.com/links/newstudent/seniorhighapplicationform.php?emailconfirmed=$email&code=$confirmed
";  
...
if($db_email==0){
        ...
        <div class="container">
          <div class="col-sm-12 col-md-12 ">
                    ...
                    <a href='seniorhighapplicationform.php?editapplication=<?php echo $db_email ?>' class='next'><i class='glyphicon glyphicon-edit'> </i> Edit Application</a>    
                    ...
                    <?php }elseif(isset($_GET['editapplication'])){?>
                        <a href='seniorhighapplicationform.php?view=<?php echo $db_email ?>' class='next'><i class='glyphicon glyphicon-search'> </i> View Application</a>
        ...
        <div class="col-sm-12 col-md-12 ">
                  ...
                  <div class="alert alert-warning">
                  <legend><a href="seniorhighapplicationform.php?editapplication=<?php echo $db_email?>">Edit Application</a> > Edit Religion</legend>
                    <form   onsubmit='return freshmanapplicationreligionupdate()' action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="POST"  enctype="multipart/form-data">
                      ...
                      <div class="col-sm-4 col-md-4">
                      Birthdate: (Day/Month/Year) <a href="seniorhighapplicationform.php?editbirthdate=<?php echo $db_email?>">Change</a>
                      <br>
                      ...
                      <div class='row'>
                       <div class="col-sm-4 col-md-4 ">
                      Gender: <i>(required)</i> <i id='gen'></i><a href="seniorhighapplicationform.php?editgender=<?php echo $db_email?>">Change</a>
        ...
        <div class="col-sm-12 col-md-12 ">
                  ...
                  <div class="alert alert-warning">
                  <legend><a href="seniorhighapplicationform.php?editapplication=<?php echo $db_email?>">Edit Application</a> > Edit Gender</legend>
                    <form   onsubmit='return freshmanapplicationgenderupdate()' action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="POST"  enctype="multipart/form-data">
                      ...
                      <div class="col-sm-4 col-md-4 ">
                      Religion:<a href="seniorhighapplicationform.php?editreligion=<?php echo $db_email ?>" id="changereligion">Change</a>
        ...
        <div class="col-sm-12 col-md-12 ">
                  ...
                  <div class="alert alert-warning">
                  <legend><a href="seniorhighapplicationform.php?editapplication=<?php echo $db_email?>">Edit Application</a> > Edit birthdate</legend>
                    <form   onsubmit='return freshmanapplicationbirthdateupdate()' action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="POST"  enctype="multipart/form-data">
                      ...
                      <div class='row'>
                      <div class="col-sm-4 col-md-4 ">
                      Gender: <a href="seniorhighapplicationform.php?editgender=<?php echo $db_email ?>" id="changegender">Change</a>
        ...
        <div class="col-sm-12 col-md-12 ">
                  ...
                  <legend>Edit Application</legend>
                    <form   onsubmit='return freshmanapplicationupdate()' action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="POST"  enctype="multipart/form-data">
                      ...
                      <div class="col-sm-4 col-md-4">
                      Birthdate: (Day/Month/Year) <i id="birth"></i> <a href="seniorhighapplicationform.php?editbirthdate=<?php echo $db_email?>" id='changebirthdate'>Change</a>
