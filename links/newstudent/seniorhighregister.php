                                                  ...
                                                  $enc_password=mysql_real_escape_string(sha1(md5(trim(htmlspecialchars($pass)))));
                                                           ...
                                                           if (preg_match("/^[_\.0-9a-zA-Z-]+@([0-9a-zA-Z][0-9a-zA-Z-]+\.)+[a-zA-Z]{2,6}$/i", $email)) {
                                                                ...
                                                                $checkemail = mysql_num_rows($remail);
                                                                      if ($checkemail != 0){
                                                                                header("Location: seniorhighregister.php?EmailAlreadyRegistered=error!");
                                                                                                                                 ...
                                                                                                                                 if(isset($_POST["captcha"]) && $_POST["captcha"]!="" && $_SESSION["code"]==$_POST["captcha"])
                                                                                                                                  {
                                                                                                                                            ...
                                                                                                                                            $qry=("INSERT into tbl_studentregistration (email,password, code, confirm_code, seeking, status, surname, firstname) values ('$email','$enc_password','0','$confirmed','Grade 11','new student','$sname','$fname')");
                                                                                                                                            mysql_query($qry);

                                                                                                                                            $message= "Confirm your email
                                                                                                                                              Click the link below to verify your account 
                                                                                                                                                http://www.yahoo.com/seniorhighregister.php?email=$email&code=$confirmed
                                                                                                                                            ";  

                                                                                                                                            mail($email,"$email Confirm Email",$message,'From: $email');
                                                                                                                                            header("Location: seniorhighregister.php?Success");
                                                                                                                                           

                                                                                                                                  }else{
                                                                                                                                    header("Location: seniorhighregister.php?WrongCodeEntered=error!");
                                                                                                                                  
                                                                                                                                  }//End of Captcha

                                                                                                                  }else{
                                                                                                                    header("Location: seniorhighregister.php?Atleast6characters=error!");
                                                                                                                   
                                                                                                                 }//End of if the password is less than 10 or greater than 6
                                                                                                   }//End of if the password is already exist!
                                                                                    }else{
                                                                                      header("Location: seniorhighregister.php?InvalidPassword=error!");
                                                                                    }
                                                            ...
                                                            header("Location: seniorhighregister.php?InvalidEmail=error!");
          ...
          <form id='register-inputs' method="POST" onsubmit="return freshmanregister()" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                            ...
                            ?>
                                          ...
                                          echo "<div class='row'><div class='col-md-6'><div class='alert alert-danger' role='alert'> <a href='' class='close' data-dismiss='alert' aria-label='close'>&times;</a>Please type a valid email!</div></div></div>"; 
                                           ...
                                           <div class='row'>
                                            <div class='col-md-6'>
                                            <strong>TO CREATE AN ACCOUNT READ THE <a href='../admission_requirements.php'>ADMISSION PROCEDURE</a>  / FOR SENIOR HIGH ONLY</strong>  
                                           ...
                                           <div class='row'>
                                            ...
                                            <a href="seniorhighregister.php" class="btn btn-danger"  >Clear</a>
                                            </div>
                                            <div class='col-md-2'>
                                            Already have an account? 
                                            <br>
                                            <a href='seniorhighlogin.php'>Login Here</a>
                                            </div>
                                            </div>
