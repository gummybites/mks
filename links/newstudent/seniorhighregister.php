                                                                      ...
                                                                      if ($checkemail != 0){
                                                                                header("Location: seniorhighregister.php?EmailAlreadyRegistered=error!");
                                                                                                 ...
                                                                                                 //Checking email if it has already registered
                                                                                                  ...
                                                                                                  if ($checkusername != 0){
                                                                                                  header("Location: seniorhighregister.php?UsernameAlreadyRegistered=error!");
                                                                                                       ...
                                                                                                       if($pass==$confirmpassword){
                                                                                                                    ...
                                                                                                                    if($checkpassword !=0){
                                                                                                                      header("Location: seniorhighregister.php?PasswordAlreadyRegistered=error!");
                                                                                                                                                   ...
                                                                                                                                                   if(isset($_POST["captcha"]) && $_POST["captcha"]!="" && $_SESSION["code"]==$_POST["captcha"])
                                                                                                                                                    {
                                                                                                                                                              ...
                                                                                                                                                              $qry=("INSERT into tbl_studentregistration (surname,firstname,username,password,email, code, confirm_code, seeking, status,prospectivestatus) values ('$sname','$fname','$username','$enc_password','$email','0','$confirmed','Grade 11','new student','pending')");
                                                                                                                                                              mysql_query($qry);

                                                                                                                                                              $message= "Confirm your email
                                                                                                                                                                Click the link below to verify your account 
                                                                                                                                                                  http://www.sims-mks.com/seniorhighapplicationform.php?email=$email&code=$confirmed
                                                                                                                                                              ";  
...
<head>
                    ...
                    <title>Senior High Create Account</title>
 ...
 <div class="container">
                                                 <br><br>
                                                      <div class="row text-center pad-top ">
                                                          <div class="col-md-12">
                                                              <strong>TO CREATE AN ACCOUNT READ THE <a href='../admissionprocedure.php'>ADMISSION PROCEDURE</a>  / FOR SENIOR HIGH ONLY</strong>  
                                                                      ...
                                                                      <b>   (*) Note: Required Fields </b>  
                                                                         ...
                                                                         <div align="center"> <img src="../../images/registration-icon.png" id='registration-icon' height="100px" width="100px"></div>
                                                                              <form role="form" method="POST" onsubmit="return freshmanregister()"  action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                                                                                  ...
                                                                                  <hr />
                                                                                  Already Registered ?   <a href='seniorhighlogin.php'>Login Here</a>
                                                                                  </form>
                                                                          </div>
