...
if(isset($_POST['login'])) 
{
    ...
    $enc_password=mysql_real_escape_string(htmlspecialchars(trim(sha1(md5($pass)))));

$qry = "SELECT * FROM tbl_studentregistration WHERE email= '$email' and seeking='Grade 11'";
         ...
         if (preg_match("/^[_\.0-9a-zA-Z-]+@([0-9a-zA-Z][0-9a-zA-Z-]+\.)+[a-zA-Z]{2,6}$/i", $email)) {
               ...
               if($enc_password==$db_password){
                                ...
                                if($db_code=='1'){
                                    ...
                                    header("Location: seniorhighapplicationform.php");
                                  

                                }else{
                                  header( "Location: seniorhighlogin.php?YourAccountIsNotActivated=error!");   

                                }
                        }else{
                           header( "Location: seniorhighlogin.php?PleaseInputcorrectpassword=error!");  

                        }
             }else{
               header( "Location: seniorhighlogin.php?PleaseInputvalidEmail=error!");  
                               ...
                               ?>           
                                            ...
                                            <div class="input-group input-group-lg">
                                              <span class="input-group-addon">
                                               ...
                                               <input type='text' value='' class='form-control input' maxlength='35'  onkeypress="return foremail(event);" ondrop="return false;" onpaste="return false;" id='email' name='email' placeholder="Email address * ex. @yahoo.com"/>
                                            ...
                                            <br>
                                            <a href='seniorhighregister.php'>It’s FREE, Sign Up Here</a>
                                            </div>
                                            </div>
