  ...
  $db_code=$qry['code'];
           ...
           if($username==$db_username) {
               ...
               if($enc_password==$db_password){
                           ...
                           header( "Location: seniorhighlogin.php?InvalidUsernameOrPassword");  
...
<head>
                    ...
                    <title>Senior High Login Account</title>
...
<body>
 ...
 <div class="container">
     ...
     <div class="row text-center pad-top ">
                                                          <div class="col-md-12">
                                                              <strong>IF YOU ALREADY HAVE AN ACCOUNT PLEASE PROCEED LOGIN/ FOR SENIOR HIGH ONLY</strong>  
                                                                          ...
                                                                          <div class="panel-body">
                                                                            <div align="center"> <img src="../../images/login-icon.png" height="100px" width="100px"></div>
                                                                              ...
                                                                              <form role="form" method="POST" onsubmit="return freshmanlogin()"  action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                                                                                  ...
                                                                                  <hr />
                                                                                  Don't have an account yet?   <a href='seniorhighregister.php'>Register Here</a>
                                                                                  </form>
                                                                          </div>
