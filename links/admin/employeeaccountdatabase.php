                ...
                <nav class="navbar-default navbar-side" role="navigation">
                    <div class="sidebar-collapse">
                        <ul class="nav" id="main-menu">
                            ...
                            <li>
                                <a class="active-menu" ><i class="fa fa-trash fa-3x"></i> Employees</a>
                            </li> 
                            <li>
                         ...
                         <?php echo "<div class='demo_jui'>
                              ...
                              <thead>
                                                              <tr><th bgcolor='#FCAC45'>ID</th>
                                                                  <th bgcolor='#FCAC45'>Employee#</th>
                                                                  <th bgcolor='#FCAC45'>Date</th>
                                                                  <th bgcolor='#FCAC45'>Access code</th>
                                                                  <th bgcolor='#FCAC45'>Firstname</th>
                                                                  <th bgcolor='#FCAC45'>Middlename</th>
                                                                  <th bgcolor='#FCAC45'>Lastname</th>
                            ...
                            while($qry = mysql_fetch_assoc($result)) {
                              ...
                              $id=$qry['id'];
                              $empID=$qry['employee_id'];
                              $joindate=$qry['joining_date'];
                              $acode=$qry['access_code'];
                              $fname=$qry['firstname'];
                              $mname=$qry['middlename'];
                              $lname=$qry['lastname'];

                     
                            echo "<tr><td>$id</td><td>$empID</td><td>$joindate</td><td>$acode</td><td>$fname</td><td>$mname</td><td>$lname</td> <td> <center> <a class='fancybox fancybox.ajax' href='addemployee.php?ppid=$id' onclick='return update()'><i class='fa fa-edit'></i></a>&nbsp<a href='deleteemloyee.php?pid=$id' onclick='return bura()' ><i class='fa fa-trash'></i></a></center></td></tr>";
                            } 
