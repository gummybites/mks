...
//if the discount is set to 10
 ...
 //if the discount is set to 17                         
}elseif($discount=='17'){
                   $x= $if-($if*(17/100));
                   $less=$payment-$x;
                   $seventeen= number_format($less,2);
                ...
                elseif($discount=='25'){
                   $x= $if-($if*(25/100));
                  $less=$payment-$x;
                $twentyfive= number_format($less,2);
...
}//if the discount is set to 27
                elseif($discount=='27'){
                   $x= $if-($if*(27/100));
                  $less=$payment-$x;
                $twentyseven= number_format($less,2);
   ...
   //if the discount is set to 30                       
                   ...
                   $x= $if-($if*(35/100));
                   $less=$payment-$x;
                   $thirtyfive= number_format($less,2);
                   ...
                   $x= $if-($if*(37/100));
                   $less=$payment-$x;
                   $thirtyseven= number_format($less,2);
...
//if the discount is set to 55                        
}elseif($discount=='55'){
                   $x= $if-($if*(55/100));
                  $less=$payment-$x;
                $fiftyfive= number_format($less,2);
...
//if the discount is set to 57                          
}elseif($discount=='57'){
                   $x= $if-($if*(57/100));
                  $less=$payment-$x;
                $fiftyseven= number_format($less,2);
...
//End of if the the mode is in cash or equal to 1
}elseif($mode=='2'){
...
// End of if the discount is set to 5              
}elseif($discount=='5'){
...
//End of if the discount is set to 7                   
}elseif($discount=='7'){
...
//End of if the discount is set to 10                        
}elseif($discount=='10'){
...
//End of if the discount is set to 20                
}elseif($discount=='15'){
                   $x= $payment-($payment*(15/100));
                  $less=$payment-$x;
                $fifteen= number_format($less,2);
...
//End of if the discount is set to 20                
 ...
 //Start of if the discount is 30                         
}elseif($discount=='25'){
...
//Start of if the discount is set to 50                          
}elseif($discount=='35'){
                   $x= $payment-($payment*(35/100));
                  $less=$payment-$x;
                $thirtyfive= number_format($less,2);
...
//Start of if the discount is set to 50                          
 ...
 //Start of if the discount is set to 100                         
}elseif($discount=='55'){
                   $x= $payment-($payment*(55/100));
                  $less=$payment-$x;
                $fiftyfive= number_format($less,2);
...
}//End of if the mode of payment is set to 1 or in installment
             ...
             <div class="col-md-5"><?php 
              echo "<form method='POST'>";
                  if(isset($_POST['submit'])){
                   ...
                   echo  "<button  type='submit' name='submit' >View Amount and Pay for Fees</button>";
